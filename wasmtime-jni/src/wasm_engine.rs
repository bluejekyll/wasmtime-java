...
pub(crate) struct WasmEngineRsImpl<'j> {
    env: JNIEnv<'j>,
}

impl<'j> crate::net_bluejekyll_wasmtime::WasmEngineRs<'j> for WasmEngineRsImpl<'j> {
    ...
    fn freeEngine(
        &self,
        class: crate::net_bluejekyll_wasmtime::net_bluejekyll_wasmtime_WasmEngineClass<'j>,
        arg0: i64,
    ) {
        todo!()
    }
    ...
    fn newModuleNtv(
        ...
        class: crate::net_bluejekyll_wasmtime::net_bluejekyll_wasmtime_WasmEngineClass<'j>,
        arg0: i64,
        arg1: jaffi_support::jni::objects::JByteBuffer<'j>,
    ) -> i64 {
        todo!()
    }
}
